# Hi there, I'm Nader Marandi 👋

📍 **Gothenburg, Sweden** | 📞 **+46 76 084 0714**

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/nader-marandi)
[![GitHub](https://img.shields.io/badge/GitHub-181717.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/nmarandi)
[![Email](https://img.shields.io/badge/Email-D14836.svg?style=for-the-badge&logo=gmail&logoColor=white)](mailto:nader.marandi69@gmail.com)
...
- Architected robust **test frameworks and automation pipelines** for comprehensive system behavior analysis and validation
- Leveraged **Microsoft Azure**, **C#**, **ASP.NET Core**, and **Azure DevOps** to streamline development workflows
- Implemented diagnostic communication protocols such as **SOVD** (Service-Oriented Vehicle Diagnostics) and **UDS**
- Utilized **SystemWeaver** for requirement traceability and test management within system verification workflows
- Performed network and diagnostic testing using **CANoe** and developed **CAPL scripts** for simulation and automation
- Enhanced integration across service-oriented architectures using **Blazor**, **gRPC**, **SignalR**, and **Azure Service Bus**
- Optimized database management with **PostgreSQL** and **Neo4j** (Graph Database)
- Worked with **Eiffel protocol** for CI/CD event-driven architecture

### **Consultant - HIL Development Engineer** | Volvo Cars (via Segula Technologies)  
*April 2023 – April 2025*
- Developed and maintained **HIL frameworks** for various automotive projects using **MATLAB/Simulink** and **ConfigurationDesk**
- Designed and implemented **reusable components and modules** to enhance efficiency and reliability of HIL testing procedures
- Managed **CI/CD pipelines** for HIL frameworks using **Jenkins**, **Gerrit**, and **Zuul**
- Contributed to development of HIL testing strategies and methodologies, continuously seeking process improvements
- Ensured quality and performance through **code reviews**, debugging, and comprehensive documentation
- Automated tasks that previously required significant manual effort
...
*May 2017 – March 2019*
- Designed and developed **testing tools for Smart Card** and smart card reader using **C#** and **C++**
- Wrote libraries for communication with Iran national ID card using **C++**, **Java**, **Python**, **C++/CLI**, and **C#**
- Developed **Android applications** for interaction with ID card
- Created software for multiple platforms: **Windows**, **Linux**, and **Android**
- Technologies: **DevExpress**, **Actor framework**, **gSOAP**

### **Projects**

#### **Embedded Software** | FANAP  
*February 2022 – August 2022*
- Worked on **IoT4 gateway development**
- Modified and customized **Linux kernel** for custom board based on **TI AM335X**
- Integrated **Yocto** into development workflow using **GitLab**
- Developed and implemented libraries for integrating **SNAP7**, **MQTT**, and **MODBUS** protocols

#### **DevOps Engineer** | Sciences Green Inc  
*March 2021 – December 2021*
- Proficient with **GitLab** for source control, **CI/CD**, and workflow management
- Configured **Nexus repository** for storing Python, npm, and Docker artifacts
- Expertise in **Nginx** configuration for reverse proxy, load balancing, and Kubernetes ingress
- Worked with **Keycloak**, **Prometheus**, **Grafana**, **Telegraf**, **InfluxDB**, **Rsyslog**, **RabbitMQ**, **Redis**, **PostgreSQL**
- Optimized Docker images for improved performance
- Integrated **SonarQube** with GitLab CI/CD pipelines for code analysis
- Administered **Kubernetes clusters** and implemented **Prometheus** and **Rook Storage** operators
- Deployed and integrated Kubernetes cluster with GitLab for CI/CD
- Collaborated with developers, guiding them using Kubernetes API
- Contributed to **Kubernetes HPA** based on GPU metrics
- Proficient in **Ansible** and **Helm** for automating infrastructure and software deployment
- Set up Kubernetes cluster monitoring
- Key contributor to significant project showcased at **nextaibox.com**
- Technologies: **Go**, **Python**, **shell scripting**
...
**M.Sc. in Electronics** | Iran University of Science and Technology  
*2012 – 2014*
- Thesis: *Design and Simulation of Up/Down Counter Based on Quantum-dot Cellular Automata*
...
📞 **Phone:** +46 76 084 0714  
📧 **Email:** [nader.marandi69@gmail.com](mailto:nader.marandi69@gmail.com)  
🔗 **LinkedIn:** [linkedin.com/in/nader-marandi](https://www.linkedin.com/in/nader-marandi)  
💻 **GitHub:** [github.com/nmarandi](https://github.com/nmarandi)  
